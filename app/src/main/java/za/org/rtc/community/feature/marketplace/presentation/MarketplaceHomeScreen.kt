        ...
        is MarketplaceLoadState.Failure -> Column(
            ...
            Text(
                ...
                modifier = Modifier.padding(
                    top = RtcSpacing.compact,
                    bottom = RtcSpacing.standard,
                ),
                style = MaterialTheme.typography.bodyMedium,
...
private fun MarketplaceHomeContent(
    ...
    LazyColumn(
        ...
        if (home.categories.isNotEmpty()) {
            item {
                Column(verticalArrangement = Arrangement.spacedBy(RtcSpacing.controlGap)) {
                    Text(
                        "Browse categories",
                        style = MaterialTheme.typography.titleMedium,
                        fontWeight = FontWeight.Bold,
                    )
                    LazyRow(horizontalArrangement = Arrangement.spacedBy(RtcSpacing.controlGap)) {
