...
/** Legacy compatibility fallback. Production events must come from CommunityEventsRepository. */
@Deprecated("Production event surfaces must use authoritative repository data")
val SampleCommunityEvents: List<CommunityEvent> = emptyList()
