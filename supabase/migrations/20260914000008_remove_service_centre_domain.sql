...
-- Historical migrations remain for reproducibility; this forward migration removes
-- the obsolete database surface from environments where it was previously applied.
